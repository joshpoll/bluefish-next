...
export const text = ({ x, y, contents, fontFamily = "sans-serif", fontSize = "12px", fontStyle, fontWeight = "normal", fill }: TextParams): Glyph => {
  ...
  // console.log("measured widths", '"' + contents + '"', measurements.width, canvasMeasurements.width);
  // console.log("measured heights", '"' + contents + '"', measurements.height, canvasMeasurements.fontHeight);
  return Glyph.mk({
    // return the positioning parameters the user gave us
